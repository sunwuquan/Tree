    ...
    <div class="com-body">
        <div>
            <el-breadcrumb separator="/" separator-class="el-icon-arrow-right" class="title">
                ...
                <el-breadcrumb-item class="title_body">{{form.title}}</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="com-body-right">
            <p @click="onSubmit('form')">保存</p>
            <router-link to="/form" tag="p">取消</router-link>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                list: {},
                fileList1: [{name: 'food.jpeg', url: 'https://fuss10.elemecdn.com/3/63/4e7f3a15429bfda99bce42a18cdd1jpeg.jpeg'}],
